ticker = 'TSLA' # ticker to analyze
crypto = 'BINANCE:BTCUSDT' # crypto to analyze
interval = '1' # less than a day means only a month of data, valid options are '1' '5' '15' '30' '60' 'D' 'W' 'M'
...
change_consec = 1.20 # default 1.14
change_diff = 1.10 # default 1.14
optimize_params = True # default True
optimization_depth = 200 # default 100
