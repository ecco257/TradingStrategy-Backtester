...
CRYPTO_INTERVAL = '4h' # the amount of time in one candle for crypto (ccxt); These are the intervals for kucoin exchange, which is currently in use: 1m, 3m, 5m, 15m, 30m, 1h, 2h, 4h, 6h, 8h, 12h, 1d, 1w
