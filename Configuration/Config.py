...
DELTA_TIME = 30
TO_DATE_LESS = 0
STOCK_TICKERS = ['AMD'] # stock tickers to backtest
CRYPTO_PAIRS = ['BINANCE:BTCUSDT'] # cryptos to backtest
...
SYMBOL_TO_OPTIMIZE = 'BINANCE:BTCUSDT' # the symbol to optimize the hyperparameters for. this is needed for things such as pair trading
